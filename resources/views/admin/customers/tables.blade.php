        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold mx-4 py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Customers</h4>
              ...
              <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-12 text-end">
                        ...
                        data-bs-target="#modalCenter">Create Customer</button>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="modalCenterTitle">Create Customer</h5>
                                  <button
                                    type="button"
                                    class="btn-close"
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('customers.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                          <label class="form-label col-12  text-start" for="sim_card">SIM Card</label>
                                          <input type="text" name="sim_card" class="form-control" id="sim_card" required />
                                        </div>
                                        <div class="mb-3">
                        ...
                        <div class="modal fade" id="modalEditAdmin" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalEditAdminTitle">Edit Customer</h5>
                                    ...
                                    <div class="modal-body">
                                        <form id="editCustomerForm" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label col-12 text-start" for="edit-sim_card">SIM Card</label>
                                                <input type="text" name="sim_card" class="form-control" id="edit-sim_card" required />
                                            </div>
                                            <div class="mb-3">
              ...
              {{-- <div class="card"> --}}
                ...
                {{-- <div class="table-responsive text-nowrap"> --}}
                  <table class="table table-hover" id="table_customers">
                    <thead>
                      <tr>
                        <th>Name</th>
                        <th>Phone</th>
...
@push('js')
    <script type="text/javascript">
        ...
        $('#table_customers').on('click', '.btn-edit', function() {
            var id = $(this).data('id');

            // Mengambil data dari baris yang sesuai dengan ID
            var rowData = $('#table_customers').DataTable().row($(this).parents('tr')).data();
            ...
            $('#edit-sim_card').val(rowData.sim_card);
        ...
        $('#table_customers').on('click', '.btn-delete', function() {
            var id = $(this).data('id');
