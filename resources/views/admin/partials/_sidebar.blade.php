<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="index.html" style="text-decoration: none;" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">CarBook</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{ request()->routeIs('rentcar-info.index') ? 'active' : '' }}">
        <a href="{{ route('rentcar-info.index') }}" style="text-decoration: none;" class="menu-link">
      ...
      <li class="menu-item {{ request()->routeIs('vehicles.index') ? 'active' : '' }}">
        <a href="{{ route('vehicles.index') }}" style="text-decoration: none;" class="menu-link">
      ...
      <li class="menu-item {{ request()->routeIs('admins.index') ? 'active' : '' }}">
        <a href="{{ route('admins.index') }}" style="text-decoration: none;" class="menu-link">
